...
bool BasicTutorial_00::mouseMoved( const OIS::MouseEvent &arg )
{
	...
	bool flg = false;//BaseApplication::mouseMoved(arg);
	mMainChar->updateViewDirection(arg.state.X.rel, arg.state.Y.rel);
	return flg;
}
...
{
	bool flag = BaseApplication::keyPressed(arg);
	//bool flg = true;
...
{
	bool flag = BaseApplication::keyReleased(arg);
	//bool flg = true;
...
void BasicTutorial_00::createScene_00(void) 
{
	...
	//mCameraArr[1]->setPosition(mMainChar->getPosition() + mCameraArr[1]->getPosition());
	//mCameraArr[1]->lookAt(mMainChar->getPosition());
